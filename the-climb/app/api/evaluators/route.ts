...
export async function POST(req: Request) {
  ...
  const isGuardian = grantsFor(user.id).some((g) => g.role === "guardian" || g.role === "manager");
  ...
  const id = createEvaluator(b.name, b.category, b.email || undefined, b.phone || undefined);
