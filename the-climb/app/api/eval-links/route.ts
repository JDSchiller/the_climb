...
export async function POST(req: Request) {
  ...
  const link = createEvalLink({ evaluator_id: b.evaluator_id, athlete_id: b.athlete_id, rubric_id: b.rubric_id, note: b.note || undefined, days, created_by: user.id });
  audit("eval_link.create", link.id, user.id);
